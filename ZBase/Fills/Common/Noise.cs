...
namespace ZBase.Fills.Common
{
    public sealed class ImprovedNoise2
    {      
        public ImprovedNoise2(JavaRandom rnd) {
    ...
    {
        readonly ImprovedNoise2[] baseNoise;
        public OctaveNoise(int octaves, JavaRandom rnd) {
            baseNoise = new ImprovedNoise2[octaves];
            for (int i = 0; i < octaves; i++)
                baseNoise[i] = new ImprovedNoise2(rnd);
        }
